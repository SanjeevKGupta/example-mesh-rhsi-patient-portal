...
<body class="excursion panel">
  <section>
    <div>
      ...
      <div style="text-align: right;"><a>Representative <span id="doctor-name">-</span></a><a id="log-out-link" href="/">Log out</a></div>
      <hr>
<div class="tabs" id="tab">
  <nav>
    ...
    <a data-tab="patients">Customers</a>
  </nav>

  <div data-tab="overview" style="height: auto;">
    <h1>Hello, <span id="greeting-name">-</span></h1>
