...
<body class="excursion panel">
  <section>
    <div>
      <div class="logo"></div>
      <div class="headline">Meshmart</div>
      <div style="text-align: right;"><a>Customer <span id="patient-name">-</span></a><a id="log-out-link" href="/">Log out</a></div>
      <hr>
<div class="tabs" id="tab">
  <nav>
    ...
    <a data-tab="doctors">Representatives</a>
  </nav>

  <div data-tab="overview" style="height: auto;">
...
const appointmentTable = new gesso.Table("appointment-table", [
    ["ID", "id"],
    ["Representative", "doctor_id", (id, record, data) => data.doctors[id].name],
    ["Date and time", "datetime", datetime => new Date(datetime).toLocaleString()],
...
const billTable = new gesso.Table("bill-table", [
    ["ID", "id"],
    ["Representative", "appointment_id", (id, record, data) => data.doctors[data.appointments[id].doctor_id].name],
